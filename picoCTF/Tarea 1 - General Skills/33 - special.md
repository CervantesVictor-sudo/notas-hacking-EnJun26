...
Start your instance to see connection details.`ssh -p 55805 ctf-player@saturn.picoctf.net`The password is `fd7746b4`

## Solución
```
VictorCervantes-picoctf@webshell:~$ ssh -p 55805 ctf-player@saturn.picoctf.net
